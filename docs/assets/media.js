...
const SA_MEDIA = (() => {
  const local = {
    // Wenn du echte Bilder hast, leg sie hier ab (Dateinamen frei wÃ¤hlbar) und mappe:
  ...
  const queries = [
    ...
    {match:/sport|outdoor|mobility|mobilitÃ¤t/i, q:"robotics outdoor mobility, assistive device"},
  ...
  function unsplash(q, seed){
    // stabiler Platzhalter mit Query + optionalem Seed (fÃ¼r Wiedererkennbarkeit)
