  ...
  function init(){
    document.querySelectorAll("iframe[data-lazy]").forEach(iframe=>{
      ...
      wrapper.innerHTML=`<img src="https://img.youtube.com/vi/${iframe.dataset.id}/hqdefault.jpg" alt="Video" style="width:100%;display:block">
        <button style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);font-size:2rem;background:rgba(0,0,0,.6);color:#fff;border:0;border-radius:50%;width:60px;height:60px">▶</button>`;
      wrapper.onclick=()=>{
